...
navbarPage(
    ...
    tabPanel(
                                               ...
                                               tabPanel("Ranking",
                                                        navlistPanel(
                                                            ...
                                                            tabPanel("Plot", 
                                                                     ...
                                                                     plotlyOutput("rank_stacked_chart", width = "500px", height = "1000px")
                                                            ),
                                                            tabPanel("Table", 
        ...
        navbarMenu(
            ...
            HTML(paste0('
                 <a href="',DOMAIN, "Colombia", '" target="_self">Colombia</a>
                 <a href="',DOMAIN, "India", '" target="_self">India</a>
                 <a href="',DOMAIN, "Indonesia", '" target="_self">Indonesia</a>
                 <a href="',DOMAIN, "Malaysia", '" target="_self">Malaysia</a>
                 <a href="',DOMAIN, "Philippines", '" target="_self">Philippines</a>
                 <a href="',DOMAIN, "SouthAfrica", '" target="_self">South Africa</a>
                 <a href="',DOMAIN, "Thailand", '" target="_self">Thailand</a>
                 <a href="',DOMAIN, "Turkey", '" target="_self">Turkey</a>
            '))
        )
