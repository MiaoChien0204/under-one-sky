...
COPY Philippines-L1 /srv/shiny-server/Philippines
COPY SouthAfrica-L1 /srv/shiny-server/SouthAfrica
COPY Thailand-L1 /srv/shiny-server/Thailand
COPY Turkey-L1 /srv/shiny-server/Turkey
